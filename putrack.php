...
{
						if(document.getElementById('pname').value==""||document.getElementById('pdesc').value==""||document.getElementById('pno').value=="")
{
...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <p class="first">&nbsp;</p>
        <p class="first"><img src="img/admin.jpg" height="171" width="161"  /></p>
        ...
        <dl class="nav3-grid">
          ...
          <a href="accounts.php">ACCOUNTS TABLE</a></dt>
        </dl>
        <!-- Title -->                
        <h1>&nbsp;</h1>  
	...
	$k=mysql_fetch_array($qrys);
        ...
        <div class="column1-unit">
         ...
         <form name="addtrack" id="addtrack" action="puinserttrack.php" method="post" > 
            
            <table width="624" border="1">
              <tr>
                <td>Product Type</td>
                <td> :</td>
                <td><select name="ptype" id="ptype" onchange="add();">
                  <option name="acc">Accomadation</option>
                  <option name="apro">Apple Products</option>
                  <option name="elect">Electronics</option>
                  <option name="ifs">Items for sale</option>
                  <option name="jobs">Jobs</option>
                  <option name="veh">Vehicles</option>
                  <option name="ots">Others</option>
                </select></td>
                <td>
              </tr>
              <tr>
    ...
    <td width="22"> :</td>
    <td width="228"><input name="pname" type="text" id="pname" onChange="add();"/></td>
    <td width="164">
    
    <span  id="spname" style="display:none; color:#FF0000">* Enter Product name</span></td>
  ...
  <tr>
    ...
    <td> :</td>
    <TD><textarea rows="3" cols="23" name="pdesc" id="pdesc" onChange="add();"maxlength="50"  ></textarea></TD>
  ...
  <tr>
    <td>Price </td>
    <td>:</td>
    <td><input name="price" type="text" id="price" size="10" maxlength="10" onchange="add();" /></td>
    <td><span  id="sprice" style="display:none; color:#FF0000">* Enter Price </span></td>
  </tr>
  <tr>
    <td>Contact Info</td>
    <td>:</td>
    <td><input name="pno" type="text" id="pno" size="10" maxlength="10" onChange="add();" /></td>
    <td> <span  id="spno" style="display:none; color:#FF0000">* Enter Contact Info </span></td>
  </tr>
  <tr>
    <td>Click here to add your track</td>
    <td>:</td>
