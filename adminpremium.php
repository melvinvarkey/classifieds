...
<input type="button" style="background-color:transparent; border:none" name="face" size=13 value="">
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <h1 class="block">Confirm Premium User </h1>
        <?php
	...
	$k=mysql_fetch_array($qrys);
       ...
       <div class="column1-unit">
           <table>
            <tr>
            <th width="114" class="top" scope="col">Username</th>
            <th width="150" class="top" scope="col">Approve </th>
            <th width="312" class="top" scope="col">Date of Joining</th>
            <th width="158" class="top" scope="col">Ad Cost</th>
            </tr>
             <?php
    $sql=mysql_query("SELECT * From login_details where tou!=0");
	$sqls=mysql_query("SELECT * From register  ");
	$i=1;
	echo " <form action=adminpremium.php method=get name=r>";
...
mysql_query("update login_details set tou=2 where username='$d'");

}
header("location:adminpremium.php");
}
 ?>   </p>
        </div>          
        <!-- Content unit - One column -->
		...
		<?php echo "<input type=submit name=s class=button value='  APPROVE  '  id=submit  /></form>";?>
