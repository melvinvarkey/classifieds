...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <h1 class="first">&nbsp;</h1>
        <p class="first"><form action="puedit.php" method="post"
...
?>
        ...
        <!-- Content unit - One column -->
         ...
         <form name="regs" id="regs" action="puupdate.php" method="post" >
          ...
          <table width="630" border="1">
            ...
            <tr>
              ...
              <td><input name="tou" type="text" disabled id="tou"  value="<?php echo $b["tou"]; ?>"  /></td>
              <td>&nbsp;</td>
            </tr>
