...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
	...
	?></h1>
        ...
        <h1 class="block">INFO DETAILS</h1>
         ...
         <?php
			$selected_id=$_GET['username'];
			$qry=mysql_query("SELECT * From register WHERE username='$selected_id'");
			$d=mysql_fetch_array($qry);
         ?>
        <div class="column1-unit">
          <table width="800" border="1">
            <tr>
              <td width="179"><font size="2"><b>First Name</b></font></td>
              <td width="41">:</td>
		...
		?></td>
            ...
            <tr>
              ...
              <td>:</td>
              <td width="358"> <?php echo "<font color='#333' face='Arial, Helvetica, sans-serif' size='2'>".$d['email'] ?></td>
            </tr>
            <tr>
