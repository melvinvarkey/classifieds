...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
	...
	$k=mysql_fetch_array($qrys);
        ...
        <div class="column1-unit">
         ...
         <form name="addtrack" id="addtrack" action="inserttrack.php" method="post" >
         </form>

 </table>
          <table border="0">
            <tr>
              <th height="63" align="center" bgcolor="#000000" valign="middle"><a href="puvtrack.php">VIEW TRACK</a></th>
              <th align="center" bgcolor="#000000"><a href="puaddtrack.php">ADD TRACK</a></th> <!--sutrack-->
            </tr>
          </table>
          <p class="caption">&nbsp;</p>
        </div>          
