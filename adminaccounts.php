...
<input type="button" style="background-color:transparent; border:none" name="face" size=13 value="">
	...
	$k=mysql_fetch_array($qrys);
        ...
        <div class="column1-unit">
          <table>
            ...
            <th width="109" class="top" scope="col">Firstname</th>
            <th width="80" class="top" scope="col">Lastname</th>
            
            <th width="110" class="top" scope="col">Date of Joining</th>
            <th width="92" class="top" scope="col">Membership</th>
	...
	while($rows=mysql_fetch_array($sqls) and $row=mysql_fetch_array($sql))
	{
		...
		if($i%2==0);
		{
			...
			echo "<td>"."<b>".$dbfirstname;
			echo "<td>"."<b>".$dblastname;
			echo "<td>"."<b>".$dbdat;
			if($dbtou==0)
