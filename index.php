...
<span  id="nopass" style="display:none; color:#F00; font-size:12;">Incorrect password!</span>
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">C L A S S I F I E D S</h1>
...
<hr class="clear-contentunit" />       
        ...
        <!-- Content unit - One column -->
        <h1 class="block">S M a R T </h1>
         <div class="column1-unit">
         <h1>&nbsp;</h1>
         <p align="justify" class="style5"><font color="#666666">
         <i>SMaRT is a classified webpage. This is an ultimate knowledge gateway to Kerala.
         We want people to connect, participate and share. Hence most of the content of SMaRT comes from the online community itself.
          Our aim is to build an online community that serves all people who live in Kerala.</p>
    <p align="justify" class="style5">Participation is the heart of our website. 
    This website is created by a group of four people. This project is an outcome of a miniproject. 
    We are led by a teamleader and a mentor. Assistance were given by the supporting staffs.</p>
		...
		if($username && $password)
		{
			...
			if ($numrows!=0 && $numrowss!=0)
			{
				...
				if($username==$dbusername&&$password==$dbpassword)
				{
					if($dbusertype==3)
					{?>
                    <script language="javascript">document.getElementById("noapp").style.display='block'; </script>
                    <?php
					...
					if($_SESSION['tou']==1)
				{?>
					<script language="javascript">document.getElementById("suinfo").submit(); </script> <?php } ?>
                    					<?php
					if($_SESSION['tou']==2)
				{?>
					<script language="javascript">document.getElementById("puinfo").submit(); </script> <?php } ?>
