...
if($_SESSION['username']&&$_SESSION['password'])
{
	...
	$sql=mysql_query("SELECT * From login_details WHERE username='$checkusername' and password='$checkpassword'");
	$sqls=mysql_query("SELECT * From register WHERE tou=1");
	
	if($sql and $sqls)
	if($row=mysql_fetch_array($sql) and $rows=mysql_fetch_array($sqls))
	{
...
{
						if(document.getElementById('pdesc').value==""||document.getElementById('pno').value=="")
{
...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <dl class="nav3-grid">
          ...
          <dt><a href="sutrackdtls.php">TRACK</a></dt>
	...
	?></h1>
        ...
        <h1 class="block">ACCOMODATION</h1>
	...
	$k=mysql_fetch_array($qrys);
        ...
        <div class="column1-unit">
         ...
         <form name="addtrack" id="addtrack" action="accominsert.php" method="post" > 
            ...
            <table width="624" border="1">
    		 ...
    		 <TD><textarea rows="3" cols="23" name="pdesc" id="pdesc"  maxlength="20"  /></textarea></TD>
    		 <td >
              ...
              <td><select name="price" id="price" />
                  <option name="ac">Less than 1 Lakh </option>
                  <option name="acc"> 1 lakh - 10 lakhs</option>
                  <option name="apro">10 lakhs - 20 lakhs</option>
                  <option name="apr">20 lakhs - 30 lakhs</option>
                  <option name="ab">Above 30 lakhs</option>
                  </select>
              </td>
                <td></td>
              </tr>
    ...
    <div class="footer">
      ...
      <p class="credits"> Powered by <a href="index.php" title="Classifieds management">SMaRT</a> | <a href="rules.php" title="Terms of use">Terms of Use</a> | <a href="about.php" title="Contact Us">Contact Us</a></p>
    </div>       
  </div> 
