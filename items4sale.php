...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
	...
	?></h1>
        ...
        <h1 class="block">ITEMS FOR SALE</h1>
            ...
            <table width="624" border="1">
              <tr>
                ...
                <option name="Furniture">Furniture</option>
                  <option name="Home appliances">Home Appliances</option>
    		 ...
    		 <TD width="187"><textarea rows="3" cols="23" name="pdesc" id="pdesc"  maxlength="400"  /></textarea></TD>
    		 <td width="224" >
