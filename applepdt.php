...
<input type="button" style="background-color:  inherit; border: transparent" name="face" size=13 value="">
	...
	?></h1>
        ...
        <h1 class="block">APPLE PRODUCTS</h1>
        ...
        <div class="column1-unit">
         ...
         <form name="addtrack" id="addtrack" action="accominsert.php" method="post" > 
            ...
            <table width="624" border="1">
              <tr>
                <td>i-type</td>
                <td><select name="type" id="type" onchange="add();">
                  <option name="ipad">I pad</option>
                  <option name="iphone">I phone</option>
                  <option name="ipod">I pod-Nano</option>
                  <option name="ishuffle">I shuffle</option>
                  <option name="itouch">I touch</option>
                  <option name="mac Notebook">Macbook</option>
                </select></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
             ...
             <tr>
    		 <td width="167">Product Description</td>
    		 <TD width="258"><textarea rows="3" cols="23" name="pdesc" id="pdesc"  maxlength="400"  /></textarea></TD>
    		 <td width="153" >
