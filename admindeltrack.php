...
<input type="button" style="background-color:transparent; border:none" name="face" size=13 value="">
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <h1 class="block">Delete Track</h1>
        <?php
	...
	$sqls=mysql_query("SELECT * From accomodation order by date desc");
	$i=1;
	echo " <form action=admindeltrack.php method=get name=r>";
...
header("location:admindeltrack.php");
}
 ?> 
