	...
	$k=mysql_fetch_array($qrys);
        ...
        <div class="column1-unit">
         ...
         <form name="addtrack" id="addtrack" action="inserttrack.php" method="post" >
          ...
          <table border="0">
            <tr>
              <th height="63" align="center" bgcolor="#000000" valign="middle"><a href="suvtrack.php">VIEW TRACK</a></th>
              <th align="center" bgcolor="#000000"><a href="addtrack.php">ADD TRACK</a></th> <!--sutrack-->
            </tr>
          </table>
          <p class="caption">&nbsp;</p>
          <p class="caption">&nbsp;</p>
