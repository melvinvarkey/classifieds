        ...
        <div class="column1-unit">
          ...
          <table width="545">
            <tr>
              ...
              <option value="app">Apple Products</option>
              <option value="ele">Electronics</option>
              <option value="ifs">Items for sale</option>
...
<form id=acc action="accom.php"></form>
<form id=app action="applepdt.php"></form>
<form id=ele action="electronics.php"></form>
<form id=ifs action="items4sale.php"></form>
<form id=veh action="vehicles.php"></form>
...
if($_GET)
{
					if($_GET['addtype']=='acc')
				{?>
					<script language="javascript">document.getElementById("acc").submit(); </script> <?php } ?>
				...
				{?>
					<script language="javascript">document.getElementById("app").submit(); </script> <?php } ?>
				...
				{?>
					<script language="javascript">document.getElementById("ele").submit(); </script> <?php } ?>
                    
                    <?php
					if($_GET['addtype']=='ifs')

				{?>
					<script language="javascript">document.getElementById("ifs").submit(); </script> <?php } ?>
                    
                    <?php
					if($_GET['addtype']=='veh')

				{?>
					<script language="javascript">document.getElementById("veh").submit(); </script> <?php } } ?>
